...
print("Writing Final v7 KiCad PCB and Gerber files...")
...
kicad_pcb_content = f"""(kicad_pcb
	...
	(footprint "Connector_PinHeader_2.54mm:PinHeader_1x05_P2.54mm_Horizontal" (layer "F.Cu") (at 136.95 144.5)
	...
	(footprint "Button_Switch_SMD:SW_SPDT_PCM12" (layer "F.Cu") (at 123.0 138.5)
	...
	(footprint "Connector_PinHeader_2.54mm:PinHeader_1x08_P2.54mm_Horizontal" (layer "B.Cu") (at 137.35 128.0)
...
D10*
G01X{fmt_g(130.0)}Y{fmt_g(127.5)}D02*
G01X{fmt_g(143.9)}Y{fmt_g(127.5)}D01*
G01X{fmt_g(143.9)}Y{fmt_g(146.0)}D01*
G01X{fmt_g(130.0)}Y{fmt_g(146.0)}D01*
G01X{fmt_g(130.0)}Y{fmt_g(127.5)}D01*
G04 BH1750 Female Header Housing (2.54mm wide)*
D11*
G01X{fmt_g(130.6)}Y{fmt_g(143.23)}D02*
G01X{fmt_g(143.3)}Y{fmt_g(143.23)}D01*
G01X{fmt_g(143.3)}Y{fmt_g(145.77)}D01*
G01X{fmt_g(130.6)}Y{fmt_g(145.77)}D01*
G01X{fmt_g(130.6)}Y{fmt_g(143.23)}D01*
...
G01X{fmt_g(120.25)}Y{fmt_g(146.5)}D02*
G01X{fmt_g(121.75)}Y{fmt_g(146.5)}D01*
G01X{fmt_g(121.0)}Y{fmt_g(145.75)}D02*
G01X{fmt_g(121.0)}Y{fmt_g(147.25)}D01*
G01X{fmt_g(124.25)}Y{fmt_g(146.5)}D02*
G01X{fmt_g(125.75)}Y{fmt_g(146.5)}D01*

G04 SW1 Slide Switch*
D10*
G01X{fmt_g(119.5)}Y{fmt_g(136.5)}D02*
G01X{fmt_g(126.5)}Y{fmt_g(136.5)}D01*
G01X{fmt_g(126.5)}Y{fmt_g(140.5)}D01*
G01X{fmt_g(119.5)}Y{fmt_g(140.5)}D01*
G01X{fmt_g(119.5)}Y{fmt_g(136.5)}D01*
...
D10*
G01X{fmt_g(127.0)}Y{fmt_g(126.5)}D02*
G01X{fmt_g(147.7)}Y{fmt_g(126.5)}D01*
G01X{fmt_g(147.7)}Y{fmt_g(142.15)}D01*
G01X{fmt_g(127.0)}Y{fmt_g(142.15)}D01*
G01X{fmt_g(127.0)}Y{fmt_g(126.5)}D01*
G04 GY-521 Female Header Housing (2.54mm wide)*
D11*
G01X{fmt_g(127.2)}Y{fmt_g(126.73)}D02*
G01X{fmt_g(147.5)}Y{fmt_g(126.73)}D01*
G01X{fmt_g(147.5)}Y{fmt_g(129.27)}D01*
G01X{fmt_g(127.2)}Y{fmt_g(129.27)}D01*
G01X{fmt_g(127.2)}Y{fmt_g(126.73)}D01*
...
for i in range(5):
    x = 131.87 + i * 2.54
    drl += f"X{int(round(x*1000))}Y{int(round(144.5*1000))}\n"
drl += "; J_SHT45 (5 holes)\n"
for i in range(5):
    x = 108.17 + i * 2.54
...
for i in range(8):
    x = 128.46 + i * 2.54
    drl += f"X{int(round(x*1000))}Y{int(round(128.0*1000))}\n"
...
"""
    ...
    for i in range(4):
        x = 131.87 + i * 2.54
        content += f"G01X{fmt_g(x)}Y{fmt_g(144.5)}D03*\n"
    content += f"D11*\nG01X{fmt_g(142.03)}Y{fmt_g(144.5)}D03*\n"
    ...
    content += "G04 GY-521*\nD11*\n"
    content += f"G01X{fmt_g(128.46)}Y{fmt_g(128.0)}D03*\n"
    content += "D10*\n"
    for i in range(1, 8):
        x = 128.46 + i * 2.54
        content += f"G01X{fmt_g(x)}Y{fmt_g(128.0)}D03*\n"
...
D13*
G01X{fmt_g(121.5)}Y{fmt_g(138.5)}D03*
G01X{fmt_g(123.0)}Y{fmt_g(138.5)}D03*
G01X{fmt_g(124.5)}Y{fmt_g(138.5)}D03*
...
G01X{fmt_g(122.0)}Y{fmt_g(146.5)}D02*
G01X{fmt_g(121.5)}Y{fmt_g(146.0)}D01*
G01X{fmt_g(121.5)}Y{fmt_g(138.5)}D01*

G04 Net 4 (BAT): SW1 Pin 2 to Beetle C6 BAT*
G01X{fmt_g(123.0)}Y{fmt_g(138.5)}D02*
G01X{fmt_g(123.0)}Y{fmt_g(134.0)}D01*
G01X{fmt_g(116.11)}Y{fmt_g(127.11)}D01*
G01X{fmt_g(116.11)}Y{fmt_g(102.66)}D01*

G04 Net 2 (3V3)*
G01X{fmt_g(133.89)}Y{fmt_g(105.20)}D02*
G01X{fmt_g(133.89)}Y{fmt_g(125.0)}D01*
G01X{fmt_g(142.03)}Y{fmt_g(133.14)}D01*
G01X{fmt_g(142.03)}Y{fmt_g(144.5)}D01*
...
G01X{fmt_g(134.41)}Y{fmt_g(135.0)}D01*
G01X{fmt_g(134.41)}Y{fmt_g(144.5)}D01*
...
G01X{fmt_g(136.95)}Y{fmt_g(136.0)}D01*
G01X{fmt_g(136.95)}Y{fmt_g(144.5)}D01*
"""
    else:
...
G01X{fmt_g(133.89)}Y{fmt_g(105.20)}D02*
G01X{fmt_g(133.89)}Y{fmt_g(125.0)}D01*
G01X{fmt_g(128.46)}Y{fmt_g(127.0)}D01*
G01X{fmt_g(128.46)}Y{fmt_g(128.0)}D01*
G01X{fmt_g(128.46)}Y{fmt_g(127.0)}D02*
G01X{fmt_g(108.17)}Y{fmt_g(127.0)}D01*
G01X{fmt_g(108.17)}Y{fmt_g(127.5)}D01*

D22*
G04 Net 5 (I2C_SDA to SHT45 and GY521)*
G01X{fmt_g(116.11)}Y{fmt_g(115.36)}D02*
G01X{fmt_g(118.33)}Y{fmt_g(117.58)}D01*
G01X{fmt_g(118.33)}Y{fmt_g(127.5)}D01*
G01X{fmt_g(118.33)}Y{fmt_g(124.0)}D02*
G01X{fmt_g(136.08)}Y{fmt_g(124.0)}D01*
G01X{fmt_g(136.08)}Y{fmt_g(128.0)}D01*

G04 Net 6 (I2C_SCL to SHT45 and GY521)*
G01X{fmt_g(116.11)}Y{fmt_g(117.90)}D02*
G01X{fmt_g(115.79)}Y{fmt_g(118.22)}D01*
G01X{fmt_g(115.79)}Y{fmt_g(127.5)}D01*
G01X{fmt_g(115.79)}Y{fmt_g(123.0)}D02*
G01X{fmt_g(133.54)}Y{fmt_g(123.0)}D01*
G01X{fmt_g(133.54)}Y{fmt_g(128.0)}D01*
...
print("SUCCESS: 100% Non-Overlapping Layout Generated and Verified!")

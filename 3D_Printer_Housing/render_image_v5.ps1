...
& $openscad -o "09_assembly_view.png" --render --autocenter --viewall --imgsize=1024,768 --colorscheme="Metallic" $scadFile
...
& $openscad -o "09_exploded_view.png" --render --autocenter --viewall --imgsize=1024,768 --colorscheme="Metallic" $scadFile
...
& $openscad -o "09_cross_section_view.png" --render --camera=367,-133,156,24,56,-20 --projection=o --imgsize=1024,768 --colorscheme="Metallic" $scadFile

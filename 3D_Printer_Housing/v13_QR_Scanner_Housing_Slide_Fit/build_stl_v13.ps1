...
& $openscad -o "$PSScriptRoot\13_housing_left.stl" $scadFile
...
& $openscad -o "$PSScriptRoot\13_housing_right.stl" $scadFile
...
& $openscad -o "$PSScriptRoot\13_trigger_button.stl" $scadFile

...
& $openscad -o "$PSScriptRoot\12_assembly_view.png" --render --autocenter --viewall --imgsize=1024,768 --colorscheme="Metallic" $scadFile
...
& $openscad -o "$PSScriptRoot\12_exploded_view.png" --render --autocenter --viewall --imgsize=1024,768 --colorscheme="Metallic" $scadFile
...
& $openscad -o "$PSScriptRoot\12_cross_section_view.png" --render --camera=350,-150,140,29,55,-15 --projection=o --imgsize=1024,768 --colorscheme="Metallic" $scadFile
...
if (Test-Path $brainDir) {
    ...
    Copy-Item -Path "$PSScriptRoot\12_assembly_view.png" -Destination (Join-Path $brainDir "12_assembly_view.png") -Force
    Copy-Item -Path "$PSScriptRoot\12_exploded_view.png" -Destination (Join-Path $brainDir "12_exploded_view.png") -Force
    Copy-Item -Path "$PSScriptRoot\12_cross_section_view.png" -Destination (Join-Path $brainDir "12_cross_section_view.png") -Force
}

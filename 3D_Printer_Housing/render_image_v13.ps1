...
& $openscad -o "13_assembly_view.png" --render --autocenter --viewall --imgsize=1024,768 --colorscheme="Metallic" $scadFile
...
& $openscad -o "13_exploded_view.png" --render --autocenter --viewall --imgsize=1024,768 --colorscheme="Metallic" $scadFile
...
& $openscad -o "13_cross_section_view.png" --render --camera=350,-150,140,29,55,-15 --projection=o --imgsize=1024,768 --colorscheme="Metallic" $scadFile
...
Copy-Item -Path "13_assembly_view.png" -Destination (Join-Path $brainDir "13_assembly_view.png") -Force
Copy-Item -Path "13_exploded_view.png" -Destination (Join-Path $brainDir "13_exploded_view.png") -Force
Copy-Item -Path "13_cross_section_view.png" -Destination (Join-Path $brainDir "13_cross_section_view.png") -Force

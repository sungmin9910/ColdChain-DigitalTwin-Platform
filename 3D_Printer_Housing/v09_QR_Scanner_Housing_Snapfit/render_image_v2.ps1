$scadFile = "$PSScriptRoot\09_qr_scanner_housing_snapfit_v2.scad"
$openscad = "C:\Program Files\OpenSCAD\openscad.com"

Write-Host "Rendering V2.0 (Snap-Fit Modified) 3D preview images..."
...
& $openscad -o "$PSScriptRoot\09_assembly_view_v2.png" --render --autocenter --viewall --imgsize=1024,768 --colorscheme="Metallic" $scadFile
...
& $openscad -o "$PSScriptRoot\09_exploded_view_v2.png" --render --autocenter --viewall --imgsize=1024,768 --colorscheme="Metallic" $scadFile
...
& $openscad -o "$PSScriptRoot\09_cross_section_view_v2.png" --render --camera=367,-133,156,24,56,-20 --projection=o --imgsize=1024,768 --colorscheme="Metallic" $scadFile

# Restore to exploded state
(Get-Content $scadFile) -replace 'render_part = "[a-zA-Z_]+";', 'render_part = "exploded";' | Set-Content $scadFile

Write-Host "V2.0 image rendering completed successfully!"

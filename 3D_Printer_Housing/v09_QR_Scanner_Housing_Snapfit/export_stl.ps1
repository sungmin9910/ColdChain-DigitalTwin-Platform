...
& $openscad -o "$PSScriptRoot\09_left_half_v2.stl" $scadFile
...
& $openscad -o "$PSScriptRoot\09_right_half_v2.stl" $scadFile
...
& $openscad -o "$PSScriptRoot\09_print_all_v2.stl" $scadFile

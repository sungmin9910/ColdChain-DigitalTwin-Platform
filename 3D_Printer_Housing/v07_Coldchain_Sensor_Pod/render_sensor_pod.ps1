$scadFile = "$PSScriptRoot\07_coldchain_sensor_pod.scad"
...
& $openscad -o "$PSScriptRoot\07_assembly_view.png" --render --autocenter --viewall --imgsize=1024,768 --colorscheme="Metallic" $scadFile
...
& $openscad -o "$PSScriptRoot\07_exploded_view.png" --render --autocenter --viewall --imgsize=1024,768 --colorscheme="Metallic" $scadFile
...
& $openscad -o "$PSScriptRoot\07_cross_section_view.png" --render --camera=200,-30,50,0,0,10 --projection=o --imgsize=1024,768 --colorscheme="Metallic" $scadFile

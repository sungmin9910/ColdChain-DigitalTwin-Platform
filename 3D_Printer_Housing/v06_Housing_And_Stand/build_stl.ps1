...
& $openscad -o "$PSScriptRoot\06_housing_body.stl" $scadFile
...
& $openscad -o "$PSScriptRoot\06_housing_handle.stl" $scadFile
...
& $openscad -o "$PSScriptRoot\06_housing_lid.stl" $scadFile
...
& $openscad -o "$PSScriptRoot\06_housing_print_all.stl" $scadFile

$scadFile = "$PSScriptRoot\06_scanner_desktop_stand.scad"
...
& $openscad -o "$PSScriptRoot\06_stand_assembly_view.png" --render --camera=220,-140,110,0,20,45 --projection=o --imgsize=1024,768 --colorscheme="Metallic" $scadFile
...
& $openscad -o "$PSScriptRoot\06_stand_print_view.png" --render --camera=220,-140,110,0,20,45 --projection=o --imgsize=1024,768 --colorscheme="Metallic" $scadFile
...
& $openscad -o "$PSScriptRoot\06_stand_cross_section_view.png" --render --camera=220,20,45,0,20,45 --projection=o --imgsize=1024,768 --colorscheme="Metallic" $scadFile

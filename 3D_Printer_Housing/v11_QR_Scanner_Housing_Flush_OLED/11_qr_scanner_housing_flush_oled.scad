/* 
 * Ergonomic Pistol Grip GM77/ESP32 QR Scanner Housing Design V11.0 (OLED Flush-Mount)
 * 
 * Features:
            ...
            translate([head_w/2, 60.0, 47.9]) {
                ...
                translate([-oled_size[0]/2 - clearance - 2.0, -oled_size[1]/2, -6.0]) {
                    difference() {
                        ...
                        translate([2.0, -0.1, 3.1]) // Slot between Z = -2.9 and -1.3 (Z_abs: 45.0 to 46.6)
        ...
        union() {
            ...
            translate([head_w/2, 60.0, 47.9]) {
                ...
                translate([oled_size[0]/2 + clearance - 4.0, -oled_size[1]/2, -6.0]) {
                    difference() {
                        cube([6.0, oled_size[1], 6.0]); // solid block
                        translate([-0.2, -0.1, 3.1]) // Slot between Z = -2.9 and -1.3 (Z_abs: 45.0 to 46.6)
...
module full_housing_cuts() {
    ...
    // [New in V11.0] OLED Flat Outer Bezel Cut (Flattening the top dome surface)
    ...
    // [New in V11.0] OLED Window Cutout (centered at Y = 60.0 + 4.57 = 64.57)
